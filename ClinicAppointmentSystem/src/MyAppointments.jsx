...
const MyAppointments = ({
  ...
  const handleApprove = (id) => {
    if (typeof onApproveAppointment === "function")
      return onApproveAppointment(id);
  ...
  const handleReschedule = (id) => {
    ...
    if (newDate && newTime)
      updateAppointment(id, { date: newDate, time: newTime });
  };
              ...
              >
                <thead>
                  <tr
                    style={{
                      background:
                        "linear-gradient(135deg, #F0B400 0%, #E8A600 100%)",
                      color: "white",
                    }}
                  >
                    <th
