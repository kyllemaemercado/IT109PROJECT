...
const BookAppointment = ({ user, onBook }) => {
  ...
  const selectStyle = {
    ...
    cursor: 'pointer',
    appearance: 'none',
    backgroundImage: 'url("data:image/svg+xml;charset=UTF-8,%3csvg xmlns=%27http://www.w3.org/2000/svg%27 viewBox=%270 0 24 24%27 fill=%27none%27 stroke=%270B4F36%27 stroke-width=%272%27 stroke-linecap=%27round%27 stroke-linejoin=%27round%27%3e%3cpolyline points=%276 9 12 15 18 9%3e%3c/polyline%3e%3c/svg%3e")',
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{
            ...
            maxWidth: '600px',
            margin: '0 auto',
          }}>Schedule a consultation with our expert healthcare professionals. Fill in your details below and we'll confirm your appointment shortly.</p>
        </div>
            ...
            <div style={{
              ...
              <div>
                ...
                <select 
                  ...
                  onFocus={(e) => {
                    ...
                    e.target.style.boxShadow = '0 0 0 3px rgba(11, 79, 54, 0.15)';
                  }}
                  onBlur={(e) => {
              ...
              <div>
                <label style={{
                  ...
                  marginBottom: '12px',
                  fontSize: '15px',
                }}>👨‍⚕️ Provider Name (optional)</label>
                <input 
                  value={providerName} 
