...
import { BarChart, Bar, PieChart, Pie, Cell, Legend, Tooltip, LineChart, Line, XAxis, YAxis, CartesianGrid, ResponsiveContainer } from 'recharts';
          ...
          >
            {doctors.map((doctor) => (
              <button
                ...
                style={{
                  padding: '12px 16px',
                  border: selectedDoctor?.username === doctor.username ? '2px solid #0B4F36' : '1px solid #E5E7EB',
                  borderRadius: '8px',
                  background:
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '30px' }}>
                ...
                <div>
                  ...
                  <div style={{ marginBottom: '24px' }}>
                    ...
                    >
                      {selectedDoctor.role === 'DENTIST' ? '🦷 Dentist' : '⚕️ Physician'}
                    </p>
                  </div>
